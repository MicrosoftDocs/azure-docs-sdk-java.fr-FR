...
Les étapes suivantes détaillent la procédure de clonage du référentiel Docker Spring Boot à l’aide d’IntelliJ. Si vous voulez utiliser une ligne de commande, voir [Déployer une application Spring Boot sur Linux dans Azure Container Service][Deploy Spring Boot on Linux in AKS].
