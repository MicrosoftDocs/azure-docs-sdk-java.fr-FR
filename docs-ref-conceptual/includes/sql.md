<span data-ttu-id="e4135-101">[Configurer Azure SQL Database avec l’API de gestion][1] </span><span class="sxs-lookup"><span data-stu-id="e4135-101">[Configure Azure SQL Database with the management API][1] </span></span>  
