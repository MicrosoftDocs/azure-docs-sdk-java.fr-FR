...
## <a name="create-a-scale-set"></a><span data-ttu-id="d83e0-117">Créer un groupe identique</span><span class="sxs-lookup"><span data-stu-id="d83e0-117">Create a scale set</span></span>
